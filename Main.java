...
public class Main//VideoStoreSLL
{
...
//{
    ...
    {              
        ...
        SLLVideostore obj = new SLLVideostore();   
        ...
        {  
            ...
            System.out.println("2: To delete a video1");  
            ...
            {  
                case 1 :   
                    System.out.println("Enter the Video's title:");  
                    //String get = "nana";
                    //String str= sc.next(); //reads string.
                    //obj.insertElement(sc.next());
                    name=sc.next();
                    name+=sc.nextLine();
                    obj.setVideoInStore(name);      //insertElement( sc.nextInt() );
                    //sc.close();
                    break;                            
                case 2 :   
